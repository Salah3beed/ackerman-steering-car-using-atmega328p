#define F_CPU 16000000L			/* Define CPU Frequency e.g. here 8MHz */
...
int main()
{
	...
	LCD_String("Yarab nkhls");	/* write string on 1st line of LCD*/
	LCD_Command(0xC0);		/* Go to 2nd line*/
	LCD_String("Amen");	/* Write string on 2nd line*/
